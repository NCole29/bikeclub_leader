...
/**
 * Provides a list controller for ClubLeader entity.
 *
 * @ingroup club
 */
class ClubLeaderListBuilder extends EntityListBuilder {
  ...
  public function render() {
    $build['description'] = [
      '#markup' => $this->t('<p>Use Operations column to edit/delete contact record. Click name to view/edit Drupal user account.</p><p>Drupal role is automatically assigned to user, and cleared, based on position and end date. See default role per position at left.
       ...
       ['@adminlink' => $this->urlGenerator->generateFromRoute('bikeclub_leader.leader_settings'),
      ]),
    ];
   ...
   * {@inheritdoc}
   *
   * Building the header and content lines for the leader list.
   *
